...
class WrappedLlamaBlock(OptimizedLlamaDecoderLayer):
    ...
    def _reorder_cache_from_bloom_to_llama(
        ...
        # Cache slabs are allocated with full attention-head stride. For GQA,
        # 4D cache reads can therefore include unused expanded head lanes; HF
        # Llama attention expects only active KV heads.
