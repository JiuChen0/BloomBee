...
def _normalize_attention_mask(attention_mask: torch.Tensor, dtype: torch.dtype) -> torch.Tensor:
    ...
    def forward(
        ...
        **kwargs
        ...
        if attention_mask is None:
            ...
            attention_mask = _normalize_attention_mask(attention_mask, hidden_states.dtype)
