...
class WrappedMixtralBlock(MixtralDecoderLayer):
    ...
    def forward(
        ...
        **kwargs
        ...
        # tf 5.x eager/SDPA attention does not add the model-level mask for a
        # bare decoder layer. Preserve BloomBee's backend mask when present and
        # otherwise build the causal additive mask that MixtralModel would pass.
