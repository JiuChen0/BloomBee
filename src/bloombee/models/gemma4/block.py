...
def _merge_layer_type_mask(
    ...
    *,
    ...
    # The backend mask is plain causal/speculative routing and has no Gemma4
    # layer-type awareness. Keep both constraints: any position masked by
    # either input remains masked.
